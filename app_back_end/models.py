...
class PlotDadosDatabaseteste(models.Model):
    id_loja = models.IntegerField(primary_key=True)
    id_area = models.IntegerField(blank=True, null=True)
    tipo_compra = models.CharField(max_length=10, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'plot_dados_databaseteste'
